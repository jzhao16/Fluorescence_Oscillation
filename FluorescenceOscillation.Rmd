...
ggplot(df_cmd, aes(x=Period*frame_rate/1000))  + scale_x_continuous(limits = c(6, 135)) + 
...
df_stats_factor$Period <- cut(df_stats_factor$Period*frame_rate/1000, c(6, 20, 40, 60, 80, 100, 140), right = FALSE)
