...
print.df.info(df1_BG, "background")
...
h1 <- ggplot(df_cmd, aes(x=I_bar))  +
  ...
  geom_histogram(data = df_stats_RI, fill = "green", alpha =0.4, binwidth = 10) +
...
h2 <- ggplot(df_cmd, aes(x=I_std))  +
  ...
  geom_histogram(data = df_stats_RI, fill = "green", alpha =0.4, binwidth = 2) +
...
sp1 <- ggplot(df_cmd, aes(y = I_bar, x = E1))  +
  ...
  geom_point(data = df_stats_RI, color = "green", size=0.5, alpha =0.4) +
...
df_period_cmd[['Peripheral']] <- df_period_RI[['Peripheral']]
...
p6 <- ggplot(df_stats_factor_RI, aes(y = I_bar, x = Period)) + geom_boxplot(fill='red',alpha=0.6) + scale_y_continuous(limits = c(1100, 1620)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Peripheral")
...
p9 <- ggplot(df_stats_factor_BG, aes(y = I_std, x = Period)) + geom_boxplot(fill='red',alpha=0.6) + scale_y_continuous(limits = c(50, 200)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Background")

p8 <- ggplot(df_stats_factor_RI, aes(y = I_std, x = Period)) + geom_boxplot(fill='red',alpha=0.6) + scale_y_continuous(limits = c(50, 200)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Peripheral")
