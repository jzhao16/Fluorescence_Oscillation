...
write.csv(df_stats[df_stats$Indicator == 1 | df_stats$Indicator == 2,], file = "Cell-4_stats.csv")
```
...
```{r, warning=FALSE, fig.height = 3, fig.width = 4, fig.align ="center", timeit=TRUE}
...
# Divide pixels into 4 levels based on period value
df_stats_heatmap_factor <- df_stats_heatmap
df_stats_heatmap_factor$Period <- cut(df_stats_heatmap_factor$Period, c(0, 8, 20, 40, 60, 80, 100, 124), right = FALSE)
df_stats_heatmap_factor$P1 <- cut(df_stats_heatmap_factor$P1, c(0, 8, 20, 40, 60, 80, 100, 124), right = FALSE)
df_stats_heatmap_factor$P2 <- cut(df_stats_heatmap_factor$P2, c(0, 8, 20, 40, 60, 80, 100, 124), right = FALSE)
df_stats_heatmap_factor$P3 <- cut(df_stats_heatmap_factor$P3, c(0, 8, 20, 40, 60, 80, 100, 124), right = FALSE)
df_stats_heatmap_factor$P4 <- cut(df_stats_heatmap_factor$P4, c(0, 8, 20, 40, 60, 80, 100, 124), right = FALSE)

# Level 1 
df_stats_heatmap_l1 <- df_stats_heatmap
df_stats_heatmap_l1[!(df_stats_heatmap_factor$P1 %in% c("[8,20)","[20,40)")), ]$P1 <- 0
df_stats_heatmap_l1[!(df_stats_heatmap_factor$P2 %in% c("[8,20)","[20,40)")), ]$P2 <- 0
df_stats_heatmap_l1[!(df_stats_heatmap_factor$P3 %in% c("[8,20)","[20,40)")), ]$P3 <- 0
df_stats_heatmap_l1[!(df_stats_heatmap_factor$P4 %in% c("[8,20)","[20,40)")), ]$P4 <- 0
...
df_stats_heatmap_l3[!(df_stats_heatmap_factor$P1 %in% c("[80,100)","[100,124)")), ]$P1 <- 0
df_stats_heatmap_l3[!(df_stats_heatmap_factor$P2 %in% c("[80,100)","[100,124)")), ]$P2 <- 0
df_stats_heatmap_l3[!(df_stats_heatmap_factor$P3 %in% c("[80,100)","[100,124)")), ]$P3 <- 0
df_stats_heatmap_l3[!(df_stats_heatmap_factor$P4 %in% c("[80,100)","[100,124)")), ]$P4 <- 0
...
m_period_mask_cmd <- abind(matrix_period, matrix_period_mask,matrix_period_mask_l1,matrix_period_mask_l2, matrix_period_mask_l3,along = 3)
...
display(img_period_map_mask_cmd, method= 'raster', nx = -1, all=TRUE)
...
m2_sumNB <- abind(matrix_sum,matrix_NB,along=3)
...
h3 <- ggplot(df_cmd, aes(x=Amplitude))  +
  geom_histogram(data = df_stats_Cell, aes(y=..count../sum(..count..)*100), colour="blue", fill = "blue", alpha =0.3, binwidth = 1) +
  geom_histogram(data = df_stats_RI, aes(y=..count../sum(..count..)*100), colour="green", fill = "green", alpha =0.3, binwidth = 1) +
  geom_histogram(data = df_stats_BG, aes(y=..count../sum(..count..)*100), colour="red", fill = "red", alpha =0.3, binwidth = 1) +
  xlab("Average Amplitude of Principal Time-series") +
  ylab("Percentage (%)")
...
ggplot(df_cmd, aes(x=Period*frame_rate/1000))  + scale_x_continuous(limits = c(6, 96)) + 
...
```{r,warning=FALSE, fig.height = 4, fig.width = 8, fig.ncol = 1, fig.align = "center",timeit = TRUE}
# Make a df_stats copy for factors plotting
df_stats_factor <- df_stats[df_stats$Period!=0,]

df_stats_factor$Period <- cut(df_stats_factor$Period*frame_rate/1000, c(6, 16, 32, 48, 64, 80, 100), right = FALSE)
...
p5 <- ggplot(df_stats_factor_Cell, aes(y = I_bar, x = Period)) + geom_boxplot(fill='blue',alpha=0.6) + scale_y_continuous(limits = c(1100, 1620)) + 
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Cell ROI") + ylab("Average of Fluorescence Intensity") + xlab("Period (s)")
 
p7 <- ggplot(df_stats_factor_BG, aes(y = I_bar, x = Period)) + geom_boxplot(fill='red',alpha=0.6) + scale_y_continuous(limits = c(1100, 1620)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Background") + ylab("Average of Fluorescence Intensity") + xlab("Period (s)")
...
p6 <- ggplot(df_stats_factor_RI, aes(y = I_bar, x = Period)) + geom_boxplot(fill='green',alpha=0.6) + scale_y_continuous(limits = c(1100, 1620)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Peripheral") + ylab("Average of Fluorescence Intensity") + xlab("Period (s)")
...
p7 <- ggplot(df_stats_factor_Cell, aes(y = I_std, x = Period)) + geom_boxplot(fill='blue',alpha=0.6)  + scale_y_continuous(limits = c(50, 170)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Cell ROI") + ylab("Standard Deviation of Fluorescence Intensity") + xlab("Period (s)")

p9 <- ggplot(df_stats_factor_BG, aes(y = I_std, x = Period)) + geom_boxplot(fill='red',alpha=0.6) + scale_y_continuous(limits = c(50, 170)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Background") + ylab("Standard Deviation of Fluorescence Intensity") + xlab("Period (s)")

p8 <- ggplot(df_stats_factor_RI, aes(y = I_std, x = Period)) + geom_boxplot(fill='green',alpha=0.6) + scale_y_continuous(limits = c(50, 170)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Peripheral") + ylab("Standard Deviation of Fluorescence Intensity") + xlab("Period (s)")
...
p11 <- ggplot(df_stats_factor_Cell, aes(y = Amplitude, x = Period)) + geom_boxplot(fill='blue',alpha=0.6) + scale_y_continuous(limits = c(5, 62)) + 
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Cell ROI") + ylab("Average Amplitude") + xlab("Period (s)")
 
p12 <- ggplot(df_stats_factor_BG, aes(y = Amplitude, x = Period)) + geom_boxplot(fill='red',alpha=0.6) + scale_y_continuous(limits = c(5, 62)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Background") + ylab("Average Amplitude") + xlab("Period (s)")
...
p13 <- ggplot(df_stats_factor_RI, aes(y = Amplitude, x = Period)) + geom_boxplot(fill='green',alpha=0.6) + scale_y_continuous(limits = c(5, 62)) +
    stat_summary(fun.y=mean, geom="point", shape=5, size=2) + ggtitle("Peripheral") + ylab("Average Amplitude") + xlab("Period (s)")
...
p3 <- ggplot(df_ssp_dt[2:125,], aes(x=Period, y=Spec_density)) + geom_bar(stat="identity", color="black") + ggtitle("Periodgram of Detrend Fluorescence Signal") + xlab("Period (s)")
...
```{r, warning=FALSE, fig.height = 4, fig.width = 7, fig.align="center", timeit=TRUE}
set.seed(16)
df_stats_cell <- df_stats[which(df_stats$Indicator == 2),]
df_stats_factor_cell <- df_stats_cell
df_stats_factor_cell$Period <- cut(df_stats_factor_cell$Period, c(0, 8, 20, 40, 60, 80, 100, 120), right = FALSE)

s1 <- df_stats_cell[df_stats_factor_cell$Period %in% c("[0,8)"), ]
s2 <- df_stats_cell[df_stats_factor_cell$Period %in% c("[8,20)","[20,40)"), ]
s3 <- df_stats_cell[df_stats_factor_cell$Period %in% c("[40,60)","[60,80)"), ]
s4 <- df_stats_cell[df_stats_factor_cell$Period %in% c("[80,100)","[100,120)"), ]
