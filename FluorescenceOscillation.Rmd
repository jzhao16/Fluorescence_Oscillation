...
df_stats_heatmap[['Period_32']] <- 0
df_stats_heatmap[df_stats_heatmap$P1 == 32 | df_stats_heatmap$P2 == 32 | df_stats_heatmap$P3 == 32 | df_stats_heatmap$P4 == 32,]$Period_32 <- 32
df_stats_heatmap[df_stats_heatmap$Indicator == 1,]$Period_32 <- 0

df_stats_heatmap[['Period_16']] <- 0
df_stats_heatmap[df_stats_heatmap$P1 == 16 | df_stats_heatmap$P2 == 16 | df_stats_heatmap$P3 == 16 | df_stats_heatmap$P4 == 16,]$Period_16 <- 16
df_stats_heatmap[df_stats_heatmap$Indicator == 1,]$Period_16 <- 0
...
ggplot(data = df_stats_heatmap, aes(x=X, y=Y, fill=Period_32)) + scale_y_continuous(trans = "reverse") + geom_raster() +  scale_fill_gradient(low="Black", high="Dodgerblue", guide = 'legend') + theme_void()

ggplot(data = df_stats_heatmap, aes(x=X, y=Y, fill=Period_16)) + scale_y_continuous(trans = "reverse") + geom_raster() +  scale_fill_gradient(low="Black", high="Dodgerblue", guide = 'legend') + theme_void()

ggplot(data = df_stats_heatmap, aes(x=X, y=Y, fill=Period_9)) + scale_y_continuous(trans = "reverse") + geom_raster() +  scale_fill_gradient(low="Black", high="Dodgerblue", guide = 'legend') + theme_void()
...
p8 <- ggplot(df_stats_factor_RI, aes(y = I_std, x = Period)) + geom_boxplot(fill='green',alpha=0.6) + scale_y_continuous(limits = c(50, 200)) +
